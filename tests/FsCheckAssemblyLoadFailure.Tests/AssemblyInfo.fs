...
[<assembly: AssemblyTitleAttribute("FsCheckAssemblyLoadFailure.Tests")>]
[<assembly: AssemblyProductAttribute("FsCheckAssemblyLoadFailure")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FsCheckAssemblyLoadFailure.Tests"
    let [<Literal>] AssemblyProduct = "FsCheckAssemblyLoadFailure"
